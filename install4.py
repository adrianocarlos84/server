...
rDownloadURL = {"main": "https://server1804-adriano.s3.sa-east-1.amazonaws.com/main.tar.gz", "sub": "https://server1804-adriano.s3.sa-east-1.amazonaws.com/sub.tar.gz"}
...
if __name__ == "__main__":
    printc("Xtream Tunisie Codes Reborn R24 FULL - Installer", col.OKGREEN, 2)
    ...
    if rType.upper() in ["MAIN", "LB"]:
        ...
        if len(rHost) > 0 and len(rPassword) > 0 and rServerID > -1:
            ...
            if raw_input("  ").upper() == "Y":
                ...
                modifyNginx()
                start()
                printc("Installation completed (+21623131982)", col.OKGREEN, 2)
